...
/**
 * <i>Internal, used by {@link org.sedlakovi.celery.Celery} and implemented by backend providers.</i>
 *
 * <p>
...
public interface Backend extends Closeable {
    ...
    /**
     * The client ({@link org.sedlakovi.celery.Celery}) uses this method to subscribe to results of the tasks it sends.
     *
